...
public class StarSystemCreator {
    ...
    public static void makeSystem(MinecraftServer server)
    {
        ...
        try {
            ...
            FileUtils.writeLines(new File(DATALOC+"pack"+uuid+"\\pack.mcmeta"), List.of("""
                    {
                    \t"pack": {
            ...
            FileUtils.writeLines(new File(RECLOC+"pack"+uuid+"\\pack.mcmeta"), List.of("""
                    {
                    \t"pack": {
                    \t\t"description": "Generated by Dataplanets",
                    \t\t"pack_format": 34
    ...
    private static void inventSystem(MinecraftServer server,String uuid)
    {
        ...
        try {
            FileUtils.writeLines(new File(RECLOC+"pack"+uuid+"\\assets\\dataplanets\\gcyr\\planet_assets\\solar_systems\\"+systemName+".json"),solar_system);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            FileUtils.writeLines(new File(RECLOC+"pack"+uuid+"\\assets\\dataplanets\\lang\\en_us.json"),List.of(langFile.substring(0,langFile.length()-1)+"}"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
